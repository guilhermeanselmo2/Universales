...
Permonkey::Permonkey(float x, float y, Point lTile, TileMap tileMap, unordered_map<string, vector<string>> objList,CharAttributes attributes) : character(attributes.sprite, 4, -1, 4), tileMap(tileMap),
...
int Permonkey::MakeDeposit(){
	int a;
	return a;
}

void Permonkey::SetFrameCount(int frameCount){}
void Permonkey::SetFrame(int frame){}
void Permonkey::SetCurrentHeight(int currentHeight) {}