...
Sheet::Sheet() : sheet("img/objectPrev.png"), objectSprite(""), buy("img/icons/buy2.png"){
	box = Rect(450 - sheet.GetWidth() / 2, 20, sheet.GetWidth(), sheet.GetHeight());
	buyBox = Rect(box.x + box.w - 100, box.y + box.h - 75, buy.GetWidth(), buy.GetHeight());
	itemSelected = -1;
	attributesInfo[0] = Text("font/SFPixelate.ttf", 15, Text::TEXT_SOLID, "", WHITE, box.x + 350, 55);
	attributesInfo[1] = Text("font/SFPixelate.ttf", 15, Text::TEXT_SOLID, "", WHITE, box.x + 350, 225);
	attributesInfo[2] = Text("font/SFPixelate.ttf", 15, Text::TEXT_WRAPPED, "", WHITE, box.x + 310, 240, 290);
}
